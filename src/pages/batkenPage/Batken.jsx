            ...
            <div className={'container'}>
                ...
                <div className={'batken-title'}>
                    ...
                    <p className={'batken-text'}>
                        Утром 14 сентября на таджикско-кыргызской границе обострился вооруженный конфликт с применением танков, бронетранспортеров и беспилотников. Несмотря на договор о прекращении огня, боевые столкновения на границе продолжились. В ходе конфликта погибло 59 кыргызстанцев. Из зон конфликта эвакуировано более 142 тысяч человек.<br/>В связи событиями мы создали портал который позволит ускорить поиск пострадаваших желающими им помочь.
                    </p>
                </div>
                <h2>
